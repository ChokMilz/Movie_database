...
try {
    ...
    $collection = $database->selectCollection("internet_user");

    // Execute Query 2 (Example: Find all users)
    ...
    if (empty($documents)) {
        echo "<h2>Connection to MongoDB was successful but no users were found.</h2>";
    } else {
